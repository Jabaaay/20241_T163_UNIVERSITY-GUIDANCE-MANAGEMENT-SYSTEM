...
<div className="prof-card1">
  ...
  <div className="prof1">
    ...
    <button onClick={() => handleNavigation('/editProfile')}>Edit Account</button>
  ...
  <table className='t2'>
    ...
    <tr className='tr2'>
      ...
      <td className='td2'><input type="text" className='inp'  readOnly/></td>
    </tr>
    <tr className='tr2'>
    ...
    <tr>
      <button className='editBtn' onClick={() => handleNavigation('/editProfile')}>Edit Account</button>
    </tr>
  </table>
