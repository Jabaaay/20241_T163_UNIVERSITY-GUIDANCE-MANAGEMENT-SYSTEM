...
function Logins() {
  ...
  const handleSuccess = async (response) => {
    ...
    try {
      ...
      const decoded = jwtDecode(response.credential); // Check if response.credential contains valid token

      console.log(decoded); // Log to check if it contains correct values
